...
import {ZonaRPopup} from '../PopUp/ZonaRCreate';
...
export const ZonaR = ()=>{
    ...
    const fetchZonaEById = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_R/${id}`, {
        method: "GET",
        })
    ...
    const fetchZonaE  = async ()=>{
        ...
        try{
            const response = await fetch(`https://www.api-prm.somee.com/api/Zona_R/Nombre/${nombre}`);
    ...
    const getZonaEByCedula = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_R/Cedula/${cedula}`)
        .then(res=> res.json())
    ...
    const getZonaEByTelefono = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_R/Telefono/${telefono}`)
        .then(res=> res.json())
    ...
    const getZonaEByColegioElectoral = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_R/Colegio_Electoral/${colegioElectoral}`)
        .then(res=> res.json())
    ...
    const getZonaEByCoordinador = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_R/Cordinador/${coordinador}`)
        .then(res=> res.json())
