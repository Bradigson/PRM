...
import {ZonaQ2Popup} from '../PopUp/ZonaQ_2Create';
...
export const ZonaQtwo = ()=>{
    ...
    const fetchZonaEById = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_2/${id}`, {
        method: "GET",
        })
    ...
    const fetchZonaE  = async ()=>{
        ...
        try{
            const response = await fetch(`https://www.api-prm.somee.com/api/Zona_Q_2/Nombre/${nombre}`);
    ...
    const getZonaEByCedula = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_2/Cedula/${cedula}`)
        .then(res=> res.json())
    ...
    const getZonaEByTelefono = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_2/Telefono/${telefono}`)
        .then(res=> res.json())
    ...
    const getZonaEByColegioElectoral = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_2/Colegio_Electoral/${colegioElectoral}`)
        .then(res=> res.json())
    ...
    const getZonaEByCoordinador = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_2/Cordinador/${coordinador}`)
        .then(res=> res.json())
