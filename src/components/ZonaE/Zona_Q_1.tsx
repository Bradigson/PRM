...
export const ZonaQOne = ()=>{
    ...
    const fetchZonaEById = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_1/${id}`, {
        method: "GET",
        })
    ...
    const fetchZonaE  = async ()=>{
        ...
        try{
            const response = await fetch(`https://www.api-prm.somee.com/api/Zona_Q_1/Nombre/${nombre}`);
    ...
    const getZonaEByCedula = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_1/Cedula/${cedula}`)
        .then(res=> res.json())
    ...
    const getZonaEByTelefono = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_1/Telefono/${telefono}`)
        .then(res=> res.json())
    ...
    const getZonaEByColegioElectoral = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_1/Colegio_Electoral/${colegioElectoral}`)
        .then(res=> res.json())
    ...
    const getZonaEByCoordinador = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q_1/Cordinador/${coordinador}`)
        .then(res=> res.json())
