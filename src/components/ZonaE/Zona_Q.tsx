...
import {ZonaQPopup} from '../PopUp/ZonaQCreate';
...
export const ZonaQ = ()=>{
    ...
    const fetchZonaEById = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q/${id}`, {
        method: "GET",
        })
    ...
    const fetchZonaE  = async ()=>{
        ...
        try{
            const response = await fetch(`https://www.api-prm.somee.com/api/Zona_Q/Nombre/${nombre}`);
    ...
    const getZonaEByCedula = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q/Cedula/${cedula}`)
        .then(res=> res.json())
    ...
    const getZonaEByTelefono = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q/Telefono/${telefono}`)
        .then(res=> res.json())
    ...
    const getZonaEByColegioElectoral = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q/Colegio_Electoral/${colegioElectoral}`)
        .then(res=> res.json())
    ...
    const getZonaEByCoordinador = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_Q/Cordinador/${coordinador}`)
        .then(res=> res.json())
