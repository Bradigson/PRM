...
export const ZonaJ = ()=>{
    ...
    const fetchZonaEById = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_J/${id}`, {
        method: "GET",
        })
    ...
    const fetchZonaE  = async ()=>{
        ...
        try{
            const response = await fetch(`https://www.api-prm.somee.com/api/Zona_J/Nombre/${nombre}`);
    ...
    const getZonaEByCedula = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_J/Cedula/${cedula}`)
        .then(res=> res.json())
    ...
    const getZonaEByTelefono = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_J/Telefono/${telefono}`)
        .then(res=> res.json())
    ...
    const getZonaEByColegioElectoral = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_J/Colegio_Electoral/${colegioElectoral}`)
        .then(res=> res.json())
    ...
    const getZonaEByCoordinador = async()=>{
        ...
        fetch(`https://www.api-prm.somee.com/api/Zona_J/Cordinador/${coordinador}`)
        .then(res=> res.json())
