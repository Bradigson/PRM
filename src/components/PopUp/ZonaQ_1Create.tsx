...
import {zonaQ1InsertPerson} from '../../services/ServicePopUp';
...
export const ZonaQ1Popup = ()=>{
    ...
    const handleSubmit = async (e : any)=>{
        ...
        else if(coordinador == "")
        {
            ...
            setLoading(true);
            await zonaQ1InsertPerson(nombre, cedula, telefono, colegioElectoral, coordinador, setData, setLoading);
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content">
                                    <div className="modal-header">
                                        <h1 className="modal-title fs-5 text-dark" id="exampleModalToggleLabel">Zona Q-1</h1>
