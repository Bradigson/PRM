...
import {zonaR1InsertPerson} from '../../services/ServicePopUp';
...
export const ZonaR1Popup = ()=>{
    ...
    const handleSubmit = async (e : any)=>{
        ...
        else if(coordinador == "")
        {
            ...
            setLoading(true);
            await zonaR1InsertPerson(nombre, cedula, telefono, colegioElectoral, coordinador, setData, setLoading);
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content">
                                    <div className="modal-header">
                                        <h1 className="modal-title fs-5 text-dark" id="exampleModalToggleLabel">Zona R-1</h1>
