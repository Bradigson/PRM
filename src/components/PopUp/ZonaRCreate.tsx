...
import {zonaRInsertPerson} from '../../services/ServicePopUp';
...
export const ZonaRPopup = ()=>{
    ...
    const handleSubmit = async (e : any)=>{
        ...
        else if(coordinador == "")
        {
            ...
            setLoading(true);
            await zonaRInsertPerson(nombre, cedula, telefono, colegioElectoral, coordinador, setData, setLoading);
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content">
                                    <div className="modal-header">
                                        <h1 className="modal-title fs-5 text-dark" id="exampleModalToggleLabel">Zona R</h1>
